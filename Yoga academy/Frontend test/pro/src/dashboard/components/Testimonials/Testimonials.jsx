        ...
        <div className='container'>
            <div className='testimonials-content'>
                <div className='section-t text-center'>
                    <h3>Our Therapies</h3>
                    <p className='text'>Join our various Therapies to enhance your physical and mental well-being from experienced professionals.</p>
                </div>
                ...
                <div className='item-list grid text-white text-center'>
                    ...
                    <br></br>
                    <Link to = "/therapies" className='btn header-btn btn-blue'>
                        <FaPaperPlane /> <span>Book Therapies</span>
                    </Link>
                </div>
            </div>
        </div>
