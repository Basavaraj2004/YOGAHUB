...
const Progress = () => {
    ...
    useEffect(() => {
        const fetchTasksAndProgress = async () => {
            try {
                ...
                const storedCompletedTasks = JSON.parse(localStorage.getItem(`completedTasks_${user.id}_${course.id}`)) || [];
    ...
    const handleTaskCompletion = (taskId) => {
        if (!completedTasks.includes(taskId)) {
            ...
            // Store completed tasks and progress in localStorage
    ...
    const handleDaySelection = (day) => {
        const previousDayTasks = days.slice(0, day - 1).flatMap(day => day.tasks.map(task => task.id));
        ...
        <div className={styles.container}>
            ...
            {showPopup && (
                <div className={styles.popup}>
                    ...
                    <p>You need to complete all tasks from previous days before proceeding to the next day's tasks.</p>
